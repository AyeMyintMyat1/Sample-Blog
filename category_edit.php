        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="" method="post" class="my-3">
                    <div class="row">
                        <div class="col-4">
                            <input type="hidden" class="form-control" required name="id" value="<?php echo $current['id']; ?>">
                            <input type="text" class="form-control" required name="title" value="<?php echo $current['title']; ?>">
                        </div>
                        <div class="col-4">
                            <input type="color" class="form-control" required name="donut_color" value="<?php echo $current['donut_color']; ?>">
                        </div>
                        <div class="col-4">
