   ...
   <div class="card-body">
    ...
    <div class="">
     ...
     <form action="" method="post" enctype="multipart/form-data" autocomplete="on">
      <div class="mb-4">
       <input type="hidden" class="form-control" value="<?php echo $current['id'] ?>" name="id">
      </div>
      <div class="mb-4">
       <label class="mb-2" for="name">Owner Name</label>
       <input type="text" class="form-control" required value="<?php echo $current['owner_name'] ?>" name="owner_name">
      </div>
      <div class="mb-4">
       <label class="mb-2" for="photo">Photo</label>
       <input type="file" class="form-control" required value="<?php echo $current['photo'] ?>" name="photo">
      </div>
      <div class="mb-4">
       <label class="mb-2" for="link">Website Link</label>
       <input type="text" class="form-control" required value="<?php echo $current['link'] ?>" name="link">
      </div>
      <div class="mb-4">
       <label class="mb-2" for="start">Start Date</label>
       <input type="date" class="form-control" required value="<?php echo $current['start'] ?>" name="start">
      </div>
      <div class="mb-4">
       <label class="mb-2" for="end">End Date</label>
       <input type="date" class="form-control" required value="<?php echo $current['end'] ?>" name="end">
      </div>
      <div class="mb-4">
       <input type="submit" class="btn btn-primary float-end" value="Update Ads" name="updBtn">
      </div>
     </form>
    </div>
   </div>
